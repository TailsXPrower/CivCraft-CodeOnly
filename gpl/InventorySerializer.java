...
public class InventorySerializer {
	...
	private static String getSerializedItemStack(ItemStack is) {
        ...
        String isType = String.valueOf(ItemManager.getType(is.getType()));
        ...
        if (isEnch.size() > 0)
        {
            ...
            {
                serializedItemStack += "&e@" + ItemManager.getType(ench.getKey()) + "@" + ench.getValue();
            }
        }
	...
	private static ItemStack getItemStackFromSerial(String serial) {
        ...
        for (String itemInfo : serializedItemStack)
        {
            ...
            {
                is = ItemManager.createItemStack(Material.getMaterial(serial), 1);
            ...
            {
                is.addEnchantment(Enchantment.getByName(serial), Integer.valueOf(itemAttribute[2]));
            } 
