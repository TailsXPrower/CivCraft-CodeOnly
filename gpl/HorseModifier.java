...
public class HorseModifier {
    ...
    */
    public static HorseModifier spawn(Location loc, EntityType id ) {
        World w = loc.getWorld();
        try {
        	Horse horse = (Horse) w.spawnEntity(loc, id);
        	horse.setAdult();
        	setCivCraftHorse(horse);

            Object entityHorse = horse;
    ...
    */
    ...
    public static void setHorseSpeed(LivingEntity entity, double amount) {
    	...
    	entity.getAttribute( Attribute.GENERIC_MOVEMENT_SPEED).setBaseValue(amount);
    	//done??
    }
    ...
    */
    public void setTamed(boolean tamed) {
        ((Horse)entityHorse).setTamed(true);
    }
    ...
    */
    public void setSaddled(boolean saddled) {
    	((Horse)entityHorse).getInventory().setSaddle(new ItemStack(Material.SADDLE));
    }
    ...
    */
    public void setArmorItem(ItemStack i) {
        if (i != null) {
            try {
            	((Horse)entityHorse).getInventory().setArmor(i);
            } catch (Exception e) {
                e.printStackTrace();
            }
        } else {
    ...
    */
    public LivingEntity getHorse() {
        try {
            return (LivingEntity) entityHorse;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
