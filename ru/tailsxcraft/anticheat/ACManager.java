package ru.tailsxcraft.anticheat;
...
import ru.tailsxcraft.civcraft.config.ConfigValidMod;
...
import ru.tailsxcraft.civcraft.war.WarAntiCheat;
...
public class ACManager implements PluginMessageListener {
	...
	public static void init() {
        Bukkit.getMessenger().registerOutgoingPluginChannel(CivCraft.getPlugin(), "civcraft:cac");
        Bukkit.getMessenger().registerIncomingPluginChannel(CivCraft.getPlugin(), "civcraft:cac", new ACManager());
