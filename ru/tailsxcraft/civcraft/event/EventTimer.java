...
import ru.tailsxcraft.civcraft.civilization.GoldenAgeTimer;
import ru.tailsxcraft.civcraft.database.SQL;
import ru.tailsxcraft.civcraft.exception.InvalidConfiguration;
import ru.tailsxcraft.civcraft.main.CivLog;
import ru.tailsxcraft.civcraft.randomevents.RandomEventTimer;
...
//		}
		...
		/* Setup Golden Age timer. */
		try {
			GoldenAgeTimer goldenAge = new GoldenAgeTimer();
			new EventTimer("goldenage", goldenAge, goldenAge.getNextDate());
		} catch (InvalidConfiguration e) {
			e.printStackTrace();
		}
