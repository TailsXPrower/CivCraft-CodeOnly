	...
	public void OnPlayerInteractEntityEvent(PlayerInteractEntityEvent event) {
		...
		if (goodie == null) {
			...
			if (frameStore != null) {
				...
				if (frame.getItem() == null || ItemManager.getType(frame.getItem()) == CivData.AIR) {
...
//		}
	...
	public static void onPlayerProtectedFrameInteract(Player player, ItemFrameStorage clickedFrame,
		...
		if ( !clickedFrame.getTown().getCiv().getLeaderGroup().hasMember(resident) && clickedFrame.getTown().getCiv().getLeader() != resident && !clickedFrame.getTown().getMayorGroup().hasMember(resident) && 
