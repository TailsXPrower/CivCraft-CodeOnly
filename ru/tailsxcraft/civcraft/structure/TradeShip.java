...
import ru.tailsxcraft.civcraft.components.TradeLevelComponent;
import ru.tailsxcraft.civcraft.components.TradeShipResults;
import ru.tailsxcraft.civcraft.components.TradeLevelComponent.Result;
		...
		for (BlockCoord relativeCoord : tpl.commandBlockRelativeLocations) {
			...
			case "/incoming":{
				...
				if (this.getUpgradeLvl() >= ID+1) {
					...
					BlockData data3 = CivData.convertSignDataToDoubleChestData(sb, tpl, relativeCoord);
