...
import ru.tailsxcraft.civcraft.randomevents.components.HammerRate;
import ru.tailsxcraft.civcraft.randomevents.components.Happiness;
import ru.tailsxcraft.civcraft.randomevents.components.Unhappiness;
...
public class RandomEvent extends SQLObject {
	...
	public void buildComponents() {
		buildComponents("ru.tailsxcraft.civcraft.randomevents.components.", configRandomEvent.actions, actions);
		buildComponents("ru.tailsxcraft.civcraft.randomevents.components.", configRandomEvent.requirements, requirements);		
		buildComponents("ru.tailsxcraft.civcraft.randomevents.components.", configRandomEvent.success, success);		
		buildComponents("ru.tailsxcraft.civcraft.randomevents.components.", configRandomEvent.failure, failure);		
	}
