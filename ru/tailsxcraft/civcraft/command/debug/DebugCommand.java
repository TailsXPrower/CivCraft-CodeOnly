...
import ru.tailsxcraft.civcraft.command.admin.AdminTownCommand;
...
import ru.tailsxcraft.civcraft.event.GoodieRepoEvent;
...
import ru.tailsxcraft.civcraft.lorestorage.LoreStoreage;
...
import ru.tailsxcraft.civcraft.tasks.TradeGoodSignCleanupTask;
import ru.tailsxcraft.civcraft.template.Template;
import ru.tailsxcraft.civcraft.template.TemplateStream;
import ru.tailsxcraft.civcraft.threading.TaskMaster;
import ru.tailsxcraft.civcraft.threading.tasks.ChunkGenerateTask;
...
import ru.tailsxcraft.civcraft.threading.tasks.TradeGoodPostGenTask;
import ru.tailsxcraft.civcraft.threading.tasks.TrommelAsyncTask;
import ru.tailsxcraft.civcraft.threading.timers.DailyTimer;
import ru.tailsxcraft.civcraft.tutorial.CivTutorial;
import ru.tailsxcraft.civcraft.util.AsciiMap;
...
import ru.tailsxcraft.civcraft.threading.tasks.MobSpawnerPostGenTask;
...
//		//CivMessage.sendSuccess(player, "Changed block");
	...
	public void blockinfo_cmd() throws CivException {
		...
		CivMessage.send(sender, "type:"+ItemManager.getType(b)+" data:"+ItemManager.getData(b)+" name:"+b.getType().name());
...
//	}
	...
	public void restoresigns_cmd() {
		...
		for (StructureSign sign : CivGlobal.getStructureSigns()) {
			...
			direction.setFacing(sign.getDirection());
			ItemManager.setType(block, CivData.WALL_SIGN);
			ItemManager.setData(block, direction);
...
//		CivMessage.sendSuccess(sender, "Added to scoreboard");
	...
	public void dupe_cmd() throws CivException {
		...
		if (player.getInventory().getItemInMainHand() == null || ItemManager.getType(player.getInventory().getItemInMainHand()) == Material.AIR) {
