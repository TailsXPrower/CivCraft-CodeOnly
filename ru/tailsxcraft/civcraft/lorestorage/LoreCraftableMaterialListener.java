...
import ru.tailsxcraft.civcraft.config.ConfigTechItem;
	...
	public void OnCraftItemEvent(CraftItemEvent event) {
		if (event.getWhoClicked() instanceof Player) {
			...
			if (craftMat == null) {
				...
				ConfigTechItem restrictedTechItem = CivSettings.techItems.get(ItemManager.getType(resultStack));
	...
	public void OnPrepareItemCraftEvent(PrepareItemCraftEvent event) {
		...
		if (event.getRecipe() instanceof ShapedRecipe) {
			...
			if (!loreMat.isVanilla()) {
				...
				newStack = ItemManager.createItemStack(loreMat.getType(), loreMat.getCraftAmount());
			}
